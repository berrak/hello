/*
Copyright (c) 2018. Author Firstname Lastname <bekr@dell.home.tld>.
...
func TestReverse(t *testing.T) {
	...
	want = "ZYXWVUTSRQPONMLKJIHGFEDCBAzyxwvutsrqponmlkjihgfedcba"
	got = Reverse("abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ")
	if got != want {
		t.Errorf("Want %s but got %s", want, got)
	}
